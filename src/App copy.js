  ...
  <tr>
    <td width="600">
      <table cellspacing="0" cellpadding="0" border="0">
        <tr>
          <td width="568" style="background-color: #ffffff; padding-left: 16px; padding-right: 16px;">
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      {showPreview && (
        ...
        <div className="space-y-6 mt-8">
          ...
          <div id="signature-preview" className="border p-4 rounded-md bg-white">
            <table width="100%" cellPadding="0" cellSpacing="0" border="0">
              <tr>
                <td width="600">
                  <table cellSpacing="0" cellPadding="0" border="0">
                    <tr>
                      <td width="568" style={{backgroundColor: '#ffffff', paddingLeft: '16px', paddingRight: '16px'}}>
                        <table width="100%" border="0" cellPadding="0" cellSpacing="0">
                          <tr>
                            <td>
                              <div style={{lineHeight: '10px', height: '10px'}}>&nbsp;</div>
                            </td>
                          </tr>
                          <tr>
                            <td width="100%" style={{verticalAlign: 'middle'}}>
                              <table width="100%" border="0" cellPadding="0" cellSpacing="0">
                                <tr>
                                  <td style={{verticalAlign: 'middle'}}>
                                    <div style={{lineHeight: 'normal', textAlign: 'left'}}>
                                      <span style={{color: '#000000', fontWeight: 700, fontFamily: 'Karla,Arial,sans-serif', fontSize: '20px'}}>
                                        {formData.name}
                                      </span>
                                    </div>
                                  </td>
                                ...
                                <tr>
                                  <td>
                                    <div style={{lineHeight: '2px', height: '2px'}}>&nbsp;</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style={{verticalAlign: 'middle'}}>
                                    <div style={{lineHeight: 'normal', textAlign: 'left'}}>
                                      <span style={{color: '#000000', fontWeight: 500, fontFamily: 'Karla,Arial,sans-serif', fontSize: '16px', letterSpacing: '-0.5px'}}>
                                        {formData.designation}
                                      </span>
                                    </div>
                                  </td>
            ...
            <div style={{marginTop: '10px'}}>
              <a href="https://www.echologyx.com" style={{color: '#000000', textDecoration: 'underline', fontFamily: 'Karla,Arial,sans-serif'}}>
                www.echologyx.com
              </a>
            </div>

            <div style={{marginTop: '10px', display: 'flex', gap: '16px'}}>
              <a href="https://maps.app.goo.gl/J5WzxYAKaN4u5ixFA" style={{color: '#000000', textDecoration: 'underline', fontFamily: 'Karla,Arial,sans-serif', fontSize: '12px', fontWeight: 700}}>London</a>
              <a href="https://maps.app.goo.gl/2PQJL88d6vgfLUyGA" style={{color: '#000000', textDecoration: 'underline', fontFamily: 'Karla,Arial,sans-serif', fontSize: '12px', fontWeight: 700}}>Miami</a>
              <span style={{color: '#000000', fontFamily: 'Karla,Arial,sans-serif', fontSize: '12px', fontWeight: 700}}>
                Dhaka (<a href="https://maps.app.goo.gl/ZG3AGjC62uqug7JG9" style={{textDecoration: 'underline'}}>Uttara</a>, <a href="https://maps.app.goo.gl/fMc9tQecnApfQn3u7" style={{textDecoration: 'underline'}}>Dhanmondi</a>)
              </span>
              <a href="https://maps.app.goo.gl/BA89v6H3G8qyq8xa9" style={{color: '#000000', textDecoration: 'underline', fontFamily: 'Karla,Arial,sans-serif', fontSize: '12px', fontWeight: 700}}>Chattogram</a>
              <a href="https://maps.app.goo.gl/VhH1odwtXBv3ZUXp9" style={{color: '#000000', textDecoration: 'underline', fontFamily: 'Karla,Arial,sans-serif', fontSize: '12px', fontWeight: 700}}>Chennai</a>
            </div>

            <div style={{marginTop: '10px', fontSize: '8px', fontFamily: 'Karla,Arial,sans-serif', color: '#000000'}}>
              Disclaimer: This email and any attachments to it may be confidential and are intended solely for the use of the individual to whom it is addressed. Any views or opinions expressed are solely those of the author and do not necessarily represent those of EchoLogyx.<br/>If you are not the intended recipient of this email, you must neither take any action based upon its contents, nor copy or show it to anyone and delete this message immediately. Please contact the sender if you believe you have received this email in error.
            </div>
          </div>
                                  ...
                                  >
                                    <tbody>
                                      ...
                                      <tr>
                                        <td width={600}>
                                          <img
                                            src="https://plugin.markaimg.com/public/1b6a2727/gkwAqkuN97Ssnvly4qV92UM4DX9Oot.png"
                                            width={600}
                                            border={0}
                                            style={{
                                              width: "100%",
                                                                        ...
                                                                        >
                                                                          ...
                                                                          >
                                                                            <a
                                                                              ...
                                                                              href="https://maps.app.goo.gl/J5WzxYAKaN4u5ixFA"
                                                                            >
                                                                              <span>
                                                                                London
                                                                              </span>
                                                                        ...
                                                                        >
                                                                          ...
                                                                          >
                                                                            <a
                                                                              ...
                                                                              href="https://maps.app.goo.gl/2PQJL88d6vgfLUyGA"
                                                                            >
                                                                              <span>
                                                                                Miami
                                                                              </span>
                                                                        ...
                                                                        >
                                                                          ...
                                                                          >
                                                                            ...
                                                                            <a
                                                                              ...
                                                                              href="https://maps.app.goo.gl/ZG3AGjC62uqug7JG9"
                                                                            >
                                                                              <span>
                                                                                Uttara
                                                                              </span>
                                                                            ...
                                                                            <a
                                                                              ...
                                                                              href="https://maps.app.goo.gl/fMc9tQecnApfQn3u7"
                                                                            >
                                                                              <span>
                                                                                Dhanmondi
                                                                              </span>
                                                                        ...
                                                                        >
                                                                          ...
                                                                          >
                                                                            <a
                                                                              ...
                                                                              href="https://maps.app.goo.gl/BA89v6H3G8qyq8xa9"
                                                                            >
                                                                              <span>
                                                                                Chattogram
                                                                              </span>
                                                                        ...
                                                                        >
                                                                          ...
                                                                          >
                                                                            <a
                                                                              ...
                                                                              href="https://maps.app.goo.gl/VhH1odwtXBv3ZUXp9"
                                                                            >
                                                                              <span>
                                                                                Chennai
                                                                              </span>
